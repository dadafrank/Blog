    ...
    <div class="header_position">
        ...
        <nav class="header_nav">
            ...
            <ul class="nav_ul1" id="nav_ul1">
                ...
                <li class="nav_li1" onclick="changeurl(3)"><a href="article_mess.jsp" style="color: rgb(52,152,219);">&nbsp;留言管理&nbsp;</a></li>
...
<%
    //    读取文章分页后的个数
    int pagess =(int)Math.ceil((double)(Messagedao.getMessages().size())/20);
...
<section class="mess_body">
    <div class="total">留言数：<%=Messagedao.getMessages().size()%></div>
    <%
    ...
    <div class="mess_body_inf">
        <textarea readonly="readonly" style="text-align: center ;"><%=messages.get(i).getContent()%></textarea>
        <p class="p1"><%=messages.get(i).getAuthor()%></p>
        <p class="p2"><%=messages.get(i).getEmail()%></p>
        <p class="p3"><%=messages.get(i).getTime()%></p>
        <p class="p4"><a href="/Admin_Message_delete?id=<%=messages.get(i).getId()%>">删除</a></p>
    </div>
    <%
            }
        }
    ...
    <div class="page" style="width: 80%;">
        ...
        <a  class="page_add" id="page_add" href="article_mess.jsp?pages=<%=pages+1%>">+1</a>
        <a  class="page_cut" id="page_cut" href="article_mess.jsp?pages=<%=pages-1%>">-1</a>
    </div>
