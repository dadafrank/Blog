...
<section class="section">
    ...
    %>
    <form class="section_form" action="/Admin_Article_change" method="post" enctype="multipart/form-data">
        <input type="text" value="<%=article.getName()%>" placeholder="请输入标题" name="art_name" />
        <br />
        <input type="text" value="<%=article.getAuthor()%>" placeholder="请输入作者" name="art_author" />
        <br />
        <input type="text" value="<%=article.getDisc()%>" placeholder="请输入简介" name="art_disc" />
        <br />
        <textarea placeholder="请输入内容" name="art_content"><%=article.getContent()%></textarea>
        <br />
        <div class="file">
            上传图片
            <input type="file" class="file_file" name="file" />
            <input type="hidden" name="file2" value="<%=article.getUrl()%>" />
